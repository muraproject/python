...
def check_tps_data(kode_kecamatan, kode_desa, kode_tps):
    url = f"{BASE_URL}/pilkada/hhcw/pkwkk/35/3506/{kode_kecamatan}/{kode_desa}/{kode_tps}.json"
...
def scan_satu_desa(kode_kecamatan, kode_desa, nama_desa):
    url_tps = f"{BASE_URL}/wilayah/pilkada/pkwkk/35/3506/{kode_kecamatan}/{kode_desa}.json"
...
def scan_kecamatan(kode_kecamatan, nama_kecamatan):
    ...
    url_desa = f"{BASE_URL}/wilayah/pilkada/pkwkk/35/3506/{kode_kecamatan}.json"
...
def scan_kabupaten():
    print("=== SCANNING KABUPATEN KEDIRI ===")
    print(f"Waktu mulai: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    
    url_kecamatan = f"{BASE_URL}/wilayah/pilkada/pkwkk/35/3506.json"
