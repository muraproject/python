...
class APIHandler:
    def __init__(self, base_url="http://192.168.0.4:5000"):
        ...
        self.last_check = 0
        self.check_interval = 2  # Decreased to 2 seconds for faster updates
        self.cameras = []
...
def main():
    try:
        ...
        loading_label = ttk.Label(loading_frame, text="Starting Fire & Smoke Detection System...",
                                font=('Arial', 12))
        ...
        def start_app():
            ...
            try:
                ...
                root.title("Fire & Smoke Detection System - Running")
            except Exception as e:
                print(f"Error starting application: {e}")
                messagebox.showerror("Startup Error", str(e))
                root.destroy()

        # Schedule the app to start after showing loading screen
