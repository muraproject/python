    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            if attempt > 0:
                ...
                print(f"  Mencoba kembali dalam {delay:.2f} detik... (percobaan {attempt}/{max_retries})")
                time.sleep(delay)
            ...
            if attempt == max_retries:
                print(f"  Gagal setelah {max_retries} percobaan: {e}")
                raise
            else:
...
try:
    ...
    for idx, lamp in enumerate(unique_lamps, 1):
        ...
        try:
                ...
                if detail_data and len(detail_data) > 0:
                    ...
                    if 'qstime' in timestamps:
                        ...
                        if qs_datetime < one_hour_ago:
                            print(f"  WARNING: QS time lebih dari 1 jam yang lalu!")
            ...
            print(f"  Error saat mengambil detail lampu: {e}")
    ...
    print(f"Lampu dengan QS time > 1 jam yang lalu: {len(outdated_lamps)}")
