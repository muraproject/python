...
class VideoProcessorApp:
    def __init__(self, window):
        ...
        # Camera Index - Ubah nilai ini untuk memilih kamera
        self.camera_index = 0  # 0 = kamera pertama, 1 = kamera kedua, dst
    ...
    def check_api(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Check if requested camera index exists
