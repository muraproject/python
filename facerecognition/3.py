...
class FaceRecognitionSystem:
            ...
            if ret:
                ...
                for (x, y, w, h) in faces:
                    ...
                    if len(self.face_data) > 0:
                        ...
                        if max_correlation > 0.8:  # Threshold for identification
    ...
    def add_new_face(self):
        ...
        # Ask for password
        password = simpledialog.askstring("Security", "Enter admin password:", show='*')
        if password != "admin123":  # Ganti dengan sandi yang Anda inginkan
