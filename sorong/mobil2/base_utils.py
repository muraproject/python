...
class SettingsManager:
    ...
    def __init__(self):
        ...
        self.default_settings = {
            ...
            'display': {
                'resize_factor': 0.8,  # Faktor resize untuk tampilan (0.8 = 80% dari ukuran asli)
                'base_width': 800,  # Width dasar jika tidak ada ukuran asli
                'base_height': 600  # Height dasar jika tidak ada ukuran asli
            }
        }
        ...
        # Ukuran tampilan saat ini (akan diupdate setelah mendapatkan ukuran aktual)
        self.current_display_width = self.calculate_display_width()
        self.current_display_height = self.calculate_display_height()
    ...
    def calculate_display_width(self, original_width=None):
        """
        Hitung display width berdasarkan resize factor
        """
        if original_width:
            return int(original_width * self.settings['display']['resize_factor'])
        return self.settings['display']['base_width']
        
    def calculate_display_height(self, original_height=None):
        """
        Hitung display height berdasarkan resize factor
        """
        if original_height:
            return int(original_height * self.settings['display']['resize_factor'])
        return self.settings['display']['base_height']

    def update_display_size(self, original_width, original_height):
        """
        Update ukuran tampilan berdasarkan ukuran asli dan resize factor
        """
        self.current_display_width = self.calculate_display_width(original_width)
        self.current_display_height = self.calculate_display_height(original_height)
