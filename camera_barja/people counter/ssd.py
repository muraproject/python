...
while True:
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > 0.5:  # Threshold confidence
            ...
            if class_id == 15:  # Class ID untuk 'person' dalam model SSD
    ...
    # Draw counting line
    cv2.line(frame, (0, line_y+200), (frame_width, line_y-200), (0, 0, 255), 2)
    ...
    cv2.imshow("SSD Human Detection and Counting", frame)
