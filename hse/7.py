...
def main():
    ...
    print("Make sure your RTSP server is running on localhost:8554")
    print("Example RTSP servers:")
    print("  • FFmpeg: ffmpeg -re -i input.mp4 -c copy -f rtsp rtsp://localhost:8554/stream")
    print("  • GStreamer RTSP Server")
    print("  • VLC Media Server")
    print("  • IP Camera with RTSP output")
    
    # Create and run system
    system = MultiThreadSafetySystem(model, rtsp_url)
