...
class ParkingSystem:
    ...
    def exit_vehicle(self, barcode, exit_photo_path=None):
            ...
            try:
                ...
                def update_ui():
                    ...
                    if search_type == 'rfid' and vehicle.get('is_member', False):
                        ...
                        messagebox.showinfo("Sukses", f"Member {member_name} ditemukan via RFID!\nHours: {hours}, Discount: 20%")
                    else:
                        messagebox.showinfo("Sukses", f"Kendaraan ditemukan! Hours: {hours}")
    ...
    def process_exit_async(self):
        def exit_worker():
            try:
                ...
                # Process exit with the saved photo path
                vehicle = self.parking_system.exit_vehicle(self.current_barcode, saved_photo_path)
